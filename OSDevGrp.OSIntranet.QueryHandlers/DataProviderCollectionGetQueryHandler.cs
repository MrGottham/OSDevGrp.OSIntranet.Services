...
namespace OSDevGrp.OSIntranet.QueryHandlers
{
    ...
    /// </summary>
    public class DataProviderCollectionGetQueryHandler : IQueryHandler<DataProviderCollectionGetQuery, IEnumerable<DataProviderSystemView>>
    {
        ...
        /// <summary>
        /// Creates the functionality which handles the query for getting a collection of data providers.
        /// </summary>
        ...
        public DataProviderCollectionGetQueryHandler(ISystemDataRepository systemDataRepository, IFoodWasteObjectMapper foodWasteObjectMapper)
        {

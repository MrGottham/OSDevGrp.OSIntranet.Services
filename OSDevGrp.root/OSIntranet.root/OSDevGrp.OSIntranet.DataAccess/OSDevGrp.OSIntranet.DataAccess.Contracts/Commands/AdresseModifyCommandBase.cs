...
{
    /// <summary>
    /// Command til opdatering af en given baisadresse.
    /// </summary>
    [DataContract(Name = "AdresseModifyCommandBase", Namespace = SoapNamespaces.DataAccessNamespace)]
    public abstract class AdresseModifyCommandBase : ICommand
    {
        /// <summary>

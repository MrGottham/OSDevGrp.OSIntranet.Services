...
namespace OSDevGrp.OSIntranet.Tests.Unittests.Infrastructure
{
    ...
    public class ContainerTests
    {
        ...
        /// </summary>
        [Test]
        public void TestAtContainerConfigurationIndlæsesOgTyperKanResolves([Values(typeof(IContainer), typeof(IObjectMapper), typeof(ICommandBus), typeof(IQueryBus), typeof(IDomainObjectBuilder), typeof(IAdresseRepository), typeof(IFinansstyringRepository), typeof(IKonfigurationRepository), typeof(IFinansstyringService))] Type type)
        {

...
namespace OSDevGrp.OSIntranet.Tests.Unittests.Infrastructure
{
    ...
    public class ContainerTests
    {
        ...
        /// </summary>
        [Test]
        public void TestAtContainerConfigurationIndlæsesOgTyperKanResolves([Values(typeof (IContainer), typeof (IDomainObjectBuilder), typeof (IObjectMapper), typeof (IFoodWasteObjectMapper), typeof (ICommandBus), typeof (IQueryBus), typeof (IMySqlDataProvider), typeof (IFoodWasteDataProvider), typeof (IAdresseRepository), typeof (IFinansstyringRepository), typeof (IKalenderRepository), typeof (IFællesRepository), typeof (ISystemDataRepository), typeof (IKonfigurationRepository), typeof (IAdressekartotekService), typeof (IFinansstyringService), typeof (IKalenderService), typeof (ICommonService))] Type type)
        {

...
namespace OSDevGrp.OSIntranet.Tests.Unittests.Infrastructure
{
    ...
    public class ContainerTests
    {
        ...
        /// </summary>
        [Test]
        public void TestAtContainerConfigurationIndlæsesOgTyperKanResolves([Values(typeof (IContainer), typeof (IDomainObjectBuilder), typeof (IObjectMapper), typeof (IFoodWasteObjectMapper), typeof (IFaultExceptionBuilder<FoodWasteFault>), typeof (IDomainObjectValidations), typeof (ISpecification), typeof (ICommandBus), typeof (IQueryBus), typeof (ILogicExecutor), typeof (ICommonValidations), typeof (IMySqlDataProvider), typeof (IFoodWasteDataProvider), typeof (IAdresseRepository), typeof (IFinansstyringRepository), typeof (IKalenderRepository), typeof (IFællesRepository), typeof (ISystemDataRepository), typeof (IHouseholdDataRepository), typeof (IKonfigurationRepository), typeof (IAdressekartotekService), typeof (IFinansstyringService), typeof (IKalenderService), typeof (ICommonService), typeof (IFoodWasteSystemDataService), typeof (IFoodWasteHouseHoldService))] Type type)
        {

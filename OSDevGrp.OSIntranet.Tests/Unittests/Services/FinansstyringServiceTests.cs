...
namespace OSDevGrp.OSIntranet.Tests.Unittests.Services
{
    ...
    public class FinansstyringServiceTests
    {
        ...
        public void TestAtBrevhovederGetKalderQueryBus()
        {
            ...
            service.BrevhovederGet(query);
            queryBus.AssertWasCalled(
                m => m.Query<BrevhovederGetQuery, IEnumerable<BrevhovedView>>(Arg<BrevhovederGetQuery>.Is.Anything));
        }
        ...
        public void TestAtBrevhovederGetKasterIntranetRepositoryFault()
        {
            ...
            var service = new FinansstyringService(commandBus, queryBus);
            var query = new BrevhovederGetQuery();
            Assert.Throws<FaultException<IntranetRepositoryFault>>(() => service.BrevhovederGet(query));
        }
        ...
        public void TestAtBrevhovederGetKasterIntranetBusinessFault()
        {
            ...
            var service = new FinansstyringService(commandBus, queryBus);
            var query = new BrevhovederGetQuery();
            Assert.Throws<FaultException<IntranetBusinessFault>>(() => service.BrevhovederGet(query));
        }
        ...
        public void TestAtBrevhovederGetKasterIntranetSystemFault()
        {
            ...
            var service = new FinansstyringService(commandBus, queryBus);
            var query = new BrevhovederGetQuery();
            Assert.Throws<FaultException<IntranetSystemFault>>(() => service.BrevhovederGet(query));
        }

        /// <summary>
        /// Tester, at BrevhovederGet kaster en IntranetSystemFault ved en unhandled exception.
        /// </summary>
        [Test]

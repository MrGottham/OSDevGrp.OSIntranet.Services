...
{
    /// <summary>
    /// Tester datakontrakt til forespørgelse efter en given kalenderaftale til en given kalenderbruger.
    /// </summary>
    [TestFixture]
    public class KalenderbrugerAftaleGetQueryTests
    {
        /// <summary>
        ...
        public void TestAtQueryKanInitieres()
        {
            ...
            var query = fixture.CreateAnonymous<KalenderbrugerAftaleGetQuery>();

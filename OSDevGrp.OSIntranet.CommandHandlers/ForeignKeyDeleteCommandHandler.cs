...
namespace OSDevGrp.OSIntranet.CommandHandlers
{
    ...
    public class ForeignKeyDeleteCommandHandler : FoodWasteSystemDataCommandHandlerBase, ICommandHandler<ForeignKeyDeleteCommand, ServiceReceiptResponse>
    {
        ...
        public ForeignKeyDeleteCommandHandler(ISystemDataRepository systemDataRepository, IFoodWasteObjectMapper foodWasteObjectMapper, ISpecification specification, ICommonValidations commonValidations)

...
namespace OSDevGrp.OSIntranet.CommandHandlers
{
    ...
    public class TranslationModifyCommandHandler : FoodWasteSystemDataCommandHandlerBase, ICommandHandler<TranslationModifyCommand, ServiceReceiptResponse>
    {
        ...
        public TranslationModifyCommandHandler(ISystemDataRepository systemDataRepository, IFoodWasteObjectMapper foodWasteObjectMapper, ISpecification specification, ICommonValidations commonValidations)

...
namespace OSDevGrp.OSIntranet.CommandHandlers
{
    ...
    public class ForeignKeyAddCommandHandler : FoodWasteSystemDataCommandHandlerBase, ICommandHandler<ForeignKeyAddCommand, ServiceReceiptResponse>
    {
        ...
        public ForeignKeyAddCommandHandler(ISystemDataRepository systemDataRepository, IFoodWasteObjectMapper foodWasteObjectMapper, ISpecification specification, ICommonValidations commonValidations, IExceptionBuilder exceptionBuilder)

...
namespace OSDevGrp.OSIntranet.CommandHandlers
{
    ...
    public class TranslationAddCommandHandler : FoodWasteSystemDataCommandHandlerBase, ICommandHandler<TranslationAddCommand, ServiceReceiptResponse>
    {
        ...
        public TranslationAddCommandHandler(ISystemDataRepository systemDataRepository, IFoodWasteObjectMapper foodWasteObjectMapper, ISpecification specification, ICommonValidations commonValidations, IExceptionBuilder exceptionBuilder)
